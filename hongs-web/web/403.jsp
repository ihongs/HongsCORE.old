    ...
    <body>
        <div class="jumbotron" style="margin-top: 2em; background-color: #0071AD; color: #fff;">
            <div class="container">
                ...
                <p  style="font-weight: bold;"><%=CoreLocale.getInstance().translate("core.error.no.power")%>! <a href="<%=request.getContextPath()%>/" style="color: #ace;"><%=CoreLocale.getInstance().translate("core.error.go.index")%></a>.</p>
            </div>
        </div>
