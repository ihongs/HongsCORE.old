 ...
 * @version 14.8.30
 */
function HsForm(b,c){c=jQuery(c);c.data("HsForm",this);c.addClass("HsForm");var p=c.closest(".loadbox");var h=c.find("form");var l=hsGetValue(b,"saveUrl");var f=hsGetValue(b,"loadUrl");var m=hsGetValue(b,"loadMode",1);var o=hsGetValue(b,"idKey","id");if(h.length===0){h=c}this.context=c;this.loadBox=p;this.formBox=h;if(b){for(var e in b){if("_"===e.substring(0,1)||this[e]!==undefined){this[e]=b[e]}}}var q,g,d,r;var j=[];m=parseInt(m);if(1&m){q=hsSerialArr(p.data("url"));for(g=0;g<q.length;g++){j.push(q[g])}q=hsSerialArr(p.data("data"));for(g=0;g<q.length;g++){j.push(q[g])}}q=hsSerialArr(f);for(g=0;g<q.length;g++){j.push(q[g])}q=hsGetSeria(j,o);if((2&m)||q){this.load(f,j)}else{this.fillData({})}var d,r;for(g=0;g<j.length;g++){d=j[g].name;r=j[g].value;h.find("[name='"+d+"']").val(r);h.find("[data-pn='"+d+"']").val(r)}this.valiInit();this.saveInit(l)}HsForm.prototype={load:function(a,b){jQuery.hsAjax({url:a,data:b,type:"POST",dataType:"json",action:"load",async:false,cache:false,context:this,success:this.loadBack})},loadBack:function(a){a=hsResponObj(a);if(a.__success__===false){return}if(a.data){this.fillData(a.data)}if(a.info){this.fillInfo(a.info)}this.formBox.trigger("loadBack",[a])},fillData:function(g){var c,a,e,h,d,b,f;c=this.formBox.find("select[name],[data-fn]");a={};for(e=0;e<c.length;e++){h=jQuery(c[e]).attr("name");if(!h){h=jQuery(c[e]).attr("data-fn")}b=hsGetValue(g,h);a[h]=b}this._data=g;for(h in a){b=a[h];e=1;f=this.formBox.find('[name="'+h+'"]');if(f.length==0){e=0;f=this.formBox.find('[data-fn="'+h+'"]')}if(typeof(this["_fill_"+h])!=="undefined"){b=this["_fill_"+h].call(this,f,b,h,"data")}else{if(f.attr("data-ft")){d=f.attr("data-ft");if(typeof(this["_fill_"+d])!=="undefined"){b=this["_fill_"+d].call(this,f,b,h,"data")}}}if(!b){continue}if(e==0){this._fill__review(f,b,h,"data")}else{if(f.prop("tagName")=="SELECT"){this._fill__select(f,b,h,"data")}}}delete this._data},fillInfo:function(f){var b,g,d,h,c,a,e;b=this.formBox.find("input[name],textarea[name],select[name],[data-fn]");g={};for(d=0;d<b.length;d++){h=jQuery(b[d]).attr("name");if(!h){h=jQuery(b[d]).attr("data-fn")}a=hsGetValue(f,h);g[h]=a}this._info=f;for(h in g){a=g[h];d=1;e=this.formBox.find('[name="'+h+'"]');if(e.length==0){d=0;e=this.formBox.find('[data-fn="'+h+'"]')}if(typeof(this["_fill_"+h])!=="undefined"){a=this["_fill_"+h].call(this,e,a,h,"info")}else{if(e.attr("data-ft")){c=e.attr("data-ft");if(typeof(this["_fill_"+c])!=="undefined"){a=this["_fill_"+c].call(this,e,a,h,"info")}}}if(!a&&(a!==0||a!=="")){continue}if(d==0){a=this._fill__review(e,a,h,"info");e.text(a)}else{if(e.attr("type")=="checkbox"||e.attr("type")=="radio"){e.filter("[value='"+a+"']").prop("checked",true).change()}else{e.val(a).change()}}}delete this._info},saveInit:function(h){var b=this.formBox.attr("action")||h;var i=this.formBox.attr("method");var e=this.formBox.attr("enctype");var f=this.formBox;var g=this;this.formBox.attr("action",b);this.formBox.on("submit",function(){return g.verifies()});if(e==="multipart/form-data"){if(f.attr("target")==null){var c="_"+((new Date()).getTime()%86400000)+"_"+Math.floor(Math.random()*1000);var a="width:0; height:0; border:0; margin:0; padding:0; overflow:hidden; visibility:hidden;";var d=jQuery('<iframe src="about:blank" name="'+c+'" style="'+a+'"></iframe>');f.attr("target",c).before(d);d.on("load",function(){var j=d[0].contentDocument||d[0].contentWindow.document;if(j.location.href=="about:blank"){return}var k=j.body.innerHTML.replace(/(^<PRE.*?>|<\/PRE>$)/igm,"");g.saveBack(k)})}this.formBox.attr("action",hsFixUri(b))}else{f.on("submit",function(j){if(j.isDefaultPrevented()){return}j.preventDefault();jQuery.hsAjax({url:b,data:hsSerialArr(f),type:i||"POST",dataType:"json",action:"save",async:false,cache:false,global:false,context:g,complete:g.saveBack,error:function(){return false}})})}},saveBack:function(c){c=hsResponObj(c,!!this.formBox.attr("target"));if(c.__success__===false){if(typeof c.errors!=="undefined"){for(var d in c.errors){var b=c.errors[d];this.haserror(d,b)}}var a=new jQuery.Event("saveFail");this.formBox.trigger(a,[c])}else{var a=new jQuery.Event("saveBack");this.formBox.trigger(a,[c]);if(!a.isDefaultPrevented()){this.loadBox.hsClose()}}},_fill__review:function(h,l,d,m){if(m==="data"){h.data("data",l);return l}var k=h.data("data");h.removeData("data");if(!k){return l}var e=h.attr("data-vk");if(!e){e=0}var o=h.attr("data-tk");if(!o){o=1}var f,g,j={};for(f==0;f<k.length;f++){g=k[f];j[g[e]]=j[g[o]]}if(!jQuery.isArray(l)){l=[l]}h.empty();for(f==0;f<l.length;f++){h.append($('<div class="fl"></div>').text(j[l[f]]))}h.append($('<div class="cb"></div>'))},_fill__select:function(f,a,h,e){if(e!=="data"){return a}var g=f.attr("data-vk");if(!g){g=0}var b=f.attr("data-tk");if(!b){b=1}for(var d=0;d<a.length;d++){var c=jQuery("<option></option>");c.val(hsGetValue(a[d],g)).text(hsGetValue(a[d],b)).data("data",a[d]);f.append(c)}f.change()},_fill__check:function(f,a,h,e){if(e!=="data"){return a}var g=f.attr("data-vk");if(!g){g=0}var b=f.attr("data-tk");if(!b){b=1}for(var d=0;d<a.length;d++){var c=jQuery('<label><input type="checkbox"/><span></span></label>');c.find("input").attr("name",h).data(a[d]).val(hsGetValue(a[d],g));c.find("span").text(hsGetValue(a[d],b));c.data("data",a[d]);f.append(c)}f.append($('<div class="cb"></div>'));f.find(":checkbox").change()},_fill__radio:function(f,a,h,e){if(e!=="data"){return a}var g=f.attr("data-vk");if(!g){g=0}var b=f.attr("data-tk");if(!b){b=1}for(var d=0;d<a.length;d++){var c=jQuery('<label><input type="radio"/><span></span></label>');c.find("input").attr("name",h).data(a[d]).val(hsGetValue(a[d],g));c.find("span").text(hsGetValue(a[d],b));c.data("data",a[d]);f.append(c)}f.append($('<div class="cb"></div>'));f.find(":radio").change()},valiInit:function(){var a=this;this.formBox.attr("novalidate","novalidate");this.formBox.on("change","input,select,textarea,[data-fn]",function(){var b=jQuery(this);a.validate(b.attr("name")||b.attr("data-fn"))})},verifies:function(){var b=true;var a={};this.formBox.find("input,select,textarea,[data-fn]").each(function(){var e=jQuery(this);var f=e.attr("name")||e.attr("data-fn");if(!f){return true}if(a[f]===undefined){a[f]=e}else{a[f].add(e)}});for(var c in a){var d=this.validate(a[c]);if(d==false){b=false}}return b},validate:function(c){if(typeof c=="string"){c=this.formBox.find('[name="'+c+'"],[data-fn="'+c+'"]')}else{c=jQuery(c)}for(var a in this.rules){if(!c.is(a)){continue}var b=this.rules[a].call(this,c.val(),c);if(b!==true){b=c.attr("data-message")||b||hsGetLang("form.haserror");this.haserror(c,b);return false}else{this.haserror(c)}}return true},haserror:function(d,c){if(typeof d=="string"){d=this.formBox.find('[name="'+d+'"],[data-fn="'+d+'"]')}else{d=jQuery(d)}var a=d.closest(".form-group");var b=a.find(".help-block");if(b.size()==0){b=jQuery('<div class="help-block"></div>').appendTo(a)}if(c==undefined){a.removeClass("has-error");b.addClass("vh")}else{a.addClass("has-error");b.removeClass("vh");b.text(c)}},rules:{"[required]":function(b,a){if(a.is("select")){if(!b){return hsGetLang("form.requires")}}else{if(a.is(":checkbox,:radio")){if(!a.filter(":checked").length){return hsGetLang("form.requires")}}else{if(a.is(".checkbox")){if(!a.find(":checked").length){return hsGetLang("form.requires")}}else{if(a.is("ul,div")){if(!a.find(":hidden").length){return hsGetLang("form.requires")}}else{if(!b){return hsGetLang("form.required")}}}}}return true},"[pattern]":function(e,d){var b=d.attr("data-pattern");var a=d.attr("data-message");var c=/^\/(.*)\/([gim])?$/.exec(b);if(c){b=new RegExp(c[1],c[2])}else{b=new RegExp(b)}if(!b.test(e)){return hsGetLang(a)}return true},"[maxlength]":function(c,b){var a=b.attr("maxlength");if(c.length>a){return hsGetLang("form.gt.maxlength",[a])}return true},"[minlength]":function(c,b){var a=b.attr("minlength");if(c.length<a){return hsGetLang("form.lt.minlength",[a])}return true},"[max]":function(c,b){var a=b.attr("max");if(c>a){return hsGetLang("form.lt.min",[a])}return true},"[min]":function(c,b){var a=b.attr("min");if(c<a){return hsGetLang("form.lt.min",[a])}return true},"[type=number]":function(a){if(!/^-?[0-9]*(\.[0-9]+)?$/.test(a)){return hsGetLang("form.is.not.number")}return true},"[type=email]":function(a){if(!/^([a-z0-9_\.\-\+]+)@([\da-z\.\-]+)\.([a-z\.]{2,6})$/i.test(a)){return hsGetLang("form.is.not.email")}return true},"[type=url]":function(a){if(!/^(https?:\/\/)?[\da-z\.\-]+\.[a-z\.]{2,6}[#&+_\?\/\w \.\-=]*$/i.test(a)){return hsGetLang("form.is.not.url")}return true},"[data-validate]":function(e,d){var c=d.attr("data-validate");var b=d.data()?d.data():window;try{return hsGetValue(b,c).call(this,e,d)}catch(a){if(window.console){window.console.log("Call "+c+" error: "+a,e,d)}return false}},"[data-verify]":function(f,c,b){if(!f){return true}var a=true;var e=this.formBox;var d={n:c.attr("name"),v:f};if(!b){b=c.attr("data-verify")}b=b.replace(/\{(.*?)\}/g,function(g,h){return e.find("[name='"+h+"']").val()||""});jQuery.hsAjax({url:b,data:d,type:"POST",dataType:"json",async:false,cache:false,success:function(g){a=g.__success__||g.__message__}});return a},"[data-unique]":function(c,b){var a=this.rules["[data-verify]"].call(this,c,b,b.attr("data-unique"));if(typeof a==="string"){return a}else{if(!a){return hsGetLang("form.is.not.unique")}}return true},"[data-exists]":function(c,b){var a=this.rules["[data-verify]"].call(this,c,b,b.attr("data-exists"));if(typeof a==="string"){return a}else{if(!a){return hsGetLang("form.is.not.exists")}}return true},"[data-relate]":function(d,c){var b=c.attr("data-relate");var a=this.formBox.find("[name="+b+"]");if(a.val()){this.validate(a)}return true},"[data-repeat]":function(d,c){var b=c.attr("data-repeat");var a=this.formBox.find("[name="+b+"]");if(a.val()!=d){return hsGetLang("form.is.not.repeat")}return true}}};jQuery.fn.hsForm=function(a){return this._hsConstr(a,HsForm)};(function(a){a(document).on("save","form",function(b){if(b.isDefaultPrevented()){return}var c=a(this).find(":submit");c.prop("disabled",true);c.data("txt",c.text());c.text(hsGetLang("form.saving"))}).on("saveBack saveFail","form",function(){var c=a(this).find(":submit");var b=c.data("txt");if(b){c.text(b)}c.prop("disabled",false)})})(jQuery);
 ...
 * @version 14.8.30
 */
function HsList(j,c){c=jQuery(c);c.data("HsList",this);c.addClass("HsList");var o=c.closest(".loadbox");var e=c.find(".listbox");var y=c.find(".pagebox");var v=c.find(".findbox");var g=hsGetValue(j,"loadUrl");var z=hsGetValue(j,"openUrls");var d=hsGetValue(j,"sendUrls");var l=hsGetValue(j,"loadMode",1);this.pageKey=hsGetValue(j,"pageKey",hsGetConf("model.page.key","page"));this.sortKey=hsGetValue(j,"sortKey",hsGetConf("model.sort.key","sort"));this.rowsPerPage=hsGetConf("rows.per.page",25);this.firstOfPage=hsGetConf("first.of.page",1);this.context=c;this.loadBox=o;this.listBox=e;this.pageBox=y;if(j){for(var s in j){if("_"===s.substring(0,1)||this[s]!==undefined){this[s]=j[s]}}}var t,x,q,r,h;var f=this;function p(k){var D=jQuery(this);var a=k.data[1];var A=k.data[2];switch(a){case"{CONTEXT}":a=c;break;case"{LOADBOX}":a=o;break;case"{AUTOBOX}":a=D._hsTarget("@");break;case"{TABSBOX}":a=c.closest(".panes").data("rel");a=a.hsTaba(c.attr("id"));a=a[0];break;default:a=D._hsTarget(a)}if(a){a=jQuery(a)}var B=D.closest(".tooltip");if(B.length){D=B.data("trigger")}if(typeof(A)==="function"){A.call(D,a,f);return}if(0<=A.indexOf("{ID}")){var C;if(0<=jQuery.inArray(e[0],D.parents())){C=f.getRow(D)}else{C=f.getOne()}if(C==null){return}var i=C.val();A=A.replace("{ID}",encodeURIComponent(i))}f.open(D,a,A)}if(z){jQuery.each(z,function(m,k){switch(k.length){case 3:q=k[0];h=k[1];r=k[2];break;case 2:q=k[0];h=k[1];r=undefined;break;default:return}if(typeof(q)==="string"){c.on("click",q,[q,r,h],p)}else{if(q){q.on("click",[q,r,h],p)}}})}function w(i){var C=jQuery(this);var a=i.data[1];var k=i.data[2];var A=C.closest(".tooltip");if(A.length){C=A.data("trigger")}if(typeof(k)==="function"){k.call(C,a,f);return}var B;if(-1!=jQuery.inArray(e[0],C.parents())){B=f.getRow(C)}else{B=f.getAll()}if(B==null){return}f.send(C,a,k,B)}if(d){jQuery.each(d,function(m,k){switch(k.length){case 3:q=k[0];h=k[1];r=k[2];break;case 2:q=k[0];h=k[1];r=undefined;break;default:return}if(typeof(q)==="string"){c.on("click",q,[q,r,h],w)}else{if(q){q.on("click",[q,r,h],w)}}})}if(v.length){v.on("submit",function(){f.load(g,this);return false})}if(g){var b=[];l=parseInt(l);if(1&l){x=hsSerialArr(o.data("url"));for(t=0;t<x.length;t++){b.push(x[t])}x=hsSerialArr(o.data("data"));for(t=0;t<x.length;t++){b.push(x[t])}}x=hsSerialArr(g);for(t=0;t<x.length;t++){b.push(x[t])}this.load(g,b)}}HsList.prototype={load:function(a,b){if(a){this._url=a}if(b){this._data=hsSerialArr(b)}jQuery.hsAjax({url:this._url,data:this._data,type:"POST",dataType:"json",action:"load",async:false,cache:false,context:this,success:this.loadBack})},loadBack:function(a){a=hsResponObj(a);if(a.__success__===false){return}if(a.list){this.fillList(a.list)}if(a.page){this.fillPage(a.page)}this.listBox.trigger("loadBack",[a])},fillList:function(k){var e,l,c,g,s,q,o,f,d,b,r,p;e=this.listBox.find("tbody");e.empty();g=this.listBox.find("thead th, thead td");s=[];q=[];o={};for(f=0;f<g.length;f++){c=jQuery(g[f]);s.push(c.attr("class"));q.push(c.attr("data-fn"));if(c.attr("data-ft")){o[c.attr("data-fn")]=c.attr("data-ft")}if(c.hasClass("sortable")){if(c.find(".caret").size()==0){var h=this;c.append('<span class="caret"></span>');c.click(function(){var n=jQuery(this);var i=n.attr("data-sn")||n.attr("data-fn");var j="";if(n.hasClass("sort-a-z")){j="-"+i}else{if(!n.hasClass("sort-z-a")){j=i}}hsSetSeria(h._data,h.sortKey,j);h.load()})}var a=hsGetSeria(this._data,this.sortKey);var m=c.attr("data-sn")||c.attr("data-fn");c.removeClass("sort-a-z sort-z-a");if(a==m){c.addClass("sort-a-z")}else{if(a=="-"+m){c.addClass("sort-z-a")}}}}for(f=0;f<k.length;f++){l=jQuery("<tr></tr>");e.append(l);this._info=k[f];for(d=0;d<q.length;d++){c=jQuery("<td></td>");c.attr("class",s[d]);l.append(c);b=q[d];if(!b){continue}p=hsGetValue(k[f],b)||"";if(typeof(this["_fill_"+b])!=="undefined"){p=this["_fill_"+b].call(this,c,p,b);if(!p){continue}}else{if(typeof(o[b])!=="undefined"){r=o[b];if(typeof(this["_fill_"+r])!=="undefined"){p=this["_fill_"+r].call(this,c,p,b);if(!p){continue}}}}c.text(p)}}if(typeof(this._info)!=="undefined"){delete this._info}},fillPage:function(h){switch(h.errno){case 1:this.pageBox.empty().append('<div class="alert alert-warning">'+hsGetLang("list.empty")+"</div>");this.listBox.hide();return;case 2:this.pageBox.empty().append('<div class="alert alert-warning">'+hsGetLang("list.outof")+"</div>");this.listBox.hide();hsSetSerial(this._data,"page",-1);this.load();return;default:this.listBox.show()}var e,a,l,c,b,f,g=this;a=h.page||this.firstOfPage;l=h.pagecount||1;c=this.pageBox.attr("data-pn");c=c?parseInt(c):10;b=Math.floor((a-1)/c)*c+1;f=b+c-1;if(l<f){f=l}this.pageBox.empty();var d=jQuery('<ul class="fl pagination"></ul>').appendTo(this.pageBox);var j=jQuery('<ul class="fr pagination"></ul>').appendTo(this.pageBox);var m=jQuery('<select class="fr"></select>');jQuery('<div class="cb"></div>').appendTo(this.pageBox);if(1!=a){d.append(jQuery('<li><a href="javascript:;" data-pn="'+(a-1)+'">'+hsGetLang("list.prev.page")+"</a></li>"))}else{d.append(jQuery('<li class="disabled"><a href="javascript:;">'+hsGetLang("list.prev.page")+"</a></li>"))}if(l!=a){d.append(jQuery('<li><a href="javascript:;" data-pn="'+(a+1)+'">'+hsGetLang("list.next.page")+"</a></li>"))}else{d.append(jQuery('<li class="disabled"><a href="javascript:;">'+hsGetLang("list.next.page")+"</a></li>"))}if(1<b-1){j.append(jQuery('<li><a href="javascript:;" data-pn="'+1+'">'+1+"</a></li>"));j.append(jQuery('<li class="disabled" ><a href="javascript:;">...</a></li>'));j.append(jQuery('<li><a href="javascript:;" data-pn="'+(b-1)+'">'+(b-1)+"</a></li>"))}for(e=b;e<f+1;e++){var k=e==a?' class="active"':"";j.append(jQuery("<li"+k+'><a href="javascript:;" data-pn="'+e+'">'+e+"</a></li>"))}if(l>f+1){j.append(jQuery('<li><a href="javascript:;" data-pn="'+(f+1)+'">'+(f+1)+"</a></li>"));j.append(jQuery('<li class="disabled" ><a href="javascript:;">...</a></li>'));j.append(jQuery('<li><a href="javascript:;" data-pn="'+l+'">'+l+"</a></li>"))}this.pageBox.find("[data-pn="+a+"]").addClass("page-curr");this.pageBox.find("[data-pn]").on("click",function(i){hsSetSeria(g._data,g.pageKey,jQuery(this).attr("data-pn"));i.preventDefault();g.load()})},send:function(b,d,a,c){if(d&&!confirm(d)){return}var e=jQuery.extend({},hsSerialObj(a),hsSerialObj(c||{}));jQuery.hsAjax({url:a,data:c,type:"POST",dataType:"json",action:"send",button:b,async:false,cache:false,context:this,success:function(f){this.sendBack(b,f,e)}})},sendBack:function(b,d,c){d=hsResponObj(d);if(d.__success__===false){return}var a=new jQuery.Event("sendBack");b.trigger(a,[d,c]);if(a.isDefaultPrevented()){return}this.load()},open:function(b,d,a,e){var c=this;var f=jQuery.extend({},hsSerialObj(a),hsSerialObj(e||{}));if(d=="@"){d=jQuery(b).closest(".loadbox")}if(d){d.hsOpen(a,e,function(){c.openBack(b,jQuery(this),f)}).data("rel",b.closest(".loadbox")[0])}else{$.hsOpen(a,e,function(){c.openBack(b,jQuery(this),f)})}},openBack:function(a,c,d){var b=this;a.trigger("openBack",[c,d]);c.on("saveBack",function(e,f){if(e.isDefaultPrevented()){return}a.trigger(e,[f,d]);if(e.isDefaultPrevented()){return}b.load()})},getRow:function(a){return a.parents("tr").find(".checkone").filter(":checkbox,:radio,:hidden")},getAll:function(){var a=this.context.find(".checkone").filter(":checked");if(a.length==0){alert(hsGetLang("list.get.all"));return null}else{return a}},getOne:function(){var a=this.context.find(".checkone").filter(":checked");if(a.length!=1){alert(hsGetLang("list.get.one"));return null}else{return a}},_fill__check:function(c,a,b){jQuery('<input type="checkbox" class="input-checkbox checkone"/>').attr("name",b).val(a).appendTo(c);return false},_fill__radio:function(c,a,b){jQuery('<input type="radio" class="input-radio checkone"/>').attr("name",b).val(a).appendTo(c);return false},_fill__admin:function(d,a,c){var b=this.listBox.find('thead [data-fn="'+c+'"]');d.append(b.find(".vh").clone().removeClass("vh")).hsInit();return false},_fill__hdate:function(e,a,d){var c=new Date();var b=hsPrsDate(a,hsGetLang("date.format"));if(c.getYear()==b.getYear()&&c.getMonth()==b.getMonth()&&c.getDate()==b.getDate()){return hsGetLang("date.today")}else{return hsFmtDate(a,hsGetLang("date.format"))}},_fill__htime:function(e,a,d){var c=new Date();var b=hsPrsDate(a,hsGetLang("datetime.format"));if(c.getYear()==b.getYear()&&c.getMonth()==b.getMonth()&&c.getDate()==b.getDate()){return hsGetLang("time.today",{time:hsFmtDate(a,hsGetLang("time.format"))})}else{return hsFmtDate(a,hsGetLang("datetime.format"))}}};jQuery.fn.hsList=function(a){return this._hsConstr(a,HsList)};(function(a){a(document).on("click",".listbox tbody td",function(b){if(this!=b.target){return}var d=a(this).closest("tr");var c=d.find(".checkone");if(this!=c.closest("td")){d.closest("tbody").find(".checkone").not(c).prop("checked",false)}c.prop("checked",!c.prop("checked")).change()}).on("change",".HsList .checkone",function(){var d=a(this).closest(".HsList");var c=d.find(".checkone").length;var b=d.find(".checkone:checked").length;d.find(".for-select").prop("disabled",b!=1);d.find(".for-checks").prop("disabled",b==0);d.find(".checkall").prop("checked",c&&c==b)}).on("change",".HsList .checkall",function(){var b=a(this).prop("checked");var c=a(this).closest(".HsList");c.find(".checkone").prop("checked",b).trigger("change")}).on("loadBack",".HsList .listbox",function(){var b=a(this).closest(".HsList");b.find(".for-select,.for-checks").prop("disabled",true);b.find(".checkall").prop("checked",false);b.find(".checkone").change()})})(jQuery);
